...
#ifndef JEJU__MSG__DETAIL__LANE_INFO__FUNCTIONS_H_
#define JEJU__MSG__DETAIL__LANE_INFO__FUNCTIONS_H_
 ...
 * jeju__msg__LaneInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * jeju__msg__LaneInfo__Sequence__fini()
 * on the array,
...
#endif  // JEJU__MSG__DETAIL__LANE_INFO__FUNCTIONS_H_
